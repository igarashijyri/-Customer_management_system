...
ActiveRecord::Schema.define(version: 2021_04_02_050734) do
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.index ["familiy_name_kana", "given_name_kana"], name: "index_customers_on_familiy_name_kana_and_given_name_kana"
  end
  ...
  create_table "staff_members", force: :cascade do |t|
    ...
    t.index ["familiy_name_kana", "given_name_kana"], name: "index_staff_members_on_familiy_name_kana_and_given_name_kana"
  end
